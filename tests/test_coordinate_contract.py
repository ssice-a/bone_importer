...
class CoordinateContractTests(unittest.TestCase):
    ...
    def test_object_metadata_resolves_contract_defaults(self):
        ...
        self.assertFalse(coordinate_contract.resolve_object_mirror_x({"bi_export_mirror_x": False, "bmc_mirror_flip": True}, True))
        self.assertTrue(coordinate_contract.resolve_object_uv_mirror_u({"bi_export_uv_mirror_u": True, "bmc_uv_mirror_u": False}, False))
        self.assertFalse(coordinate_contract.resolve_object_uv_flip_v({"bi_export_uv_flip_v": False, "bmc_uv_flip_v": True}, True))
